...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    OutputFileName = cms.string("tagProbeFitTree_HLT_Mu17_MuTk8_"+filename+".root"),
...
########
        pt = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                #isMuonMedium =  cms.vstring("true"), #requir pass MuonID for probe track
                isMuonMedium_arbitrate =  cms.vstring("true"), #requir pass MuonID for probe track
                tag_isHLTCut_Mu17 = cms.vstring("true"), #requir tag muon to be match to HLT_Mu17
...
########
        pair_deltaR = cms.PSet(
            ...
            BinnedVariables = cms.PSet(
                ...
                eta = cms.vdouble(-2.4, 2.4),
                pt = cms.vdouble(8, 5000),
                #pair_deltaR = cms.vdouble(0., 0.1, 0.2, 0.3, 0.5),#Data    
...
########
        pair_deltaR_MuonIDisMedium = cms.PSet(
            #EfficiencyCategoryAndState = cms.vstring("isMuonMedium","true"),
