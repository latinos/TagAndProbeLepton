...
void tnp_PlotEff_Comparison( bool isSave = true ) {
  ...
  TString sample_data = "DoubleMu_IsoMu23";
  ...
  TString DATA_String = pathAnna+sample_data+"_l1pt20_Run2016GH_PTvsETA.root";
  TString DATA_start_String = pathAnna+sample_data+"_l1pt23_Run2016GH_PTvsETA.root";
