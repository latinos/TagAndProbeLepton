...
FileNameOpenData1 = "../filterTree/subTree_80X_MadGraphLikeRun2016Fill5043_IdStudy.root";

FileNameOpen1 = FileNameOpenData1;
if DataOpen == "0": 
   FileNameOpen1 = FileNameOpenMC1;

FileNameOutMC = "TnP_"+isMuonSel+"_"+MCType+Bunch+"Like"+DataType+"_"+Bunch+"_1Deff_"+FitFunction+"_M_RAW.root";
FileNameOutData = "TnP_"+isMuonSel+"_"+DataType+"_"+Bunch+"_1Deff_"+FitFunction+"_M_RAW.root";
 
FileNameOut = FileNameOutData;
if DataOpen == "0": 
   FileNameOut = FileNameOutMC;

FileNameOutMCISO = "TnP_TightISO_"+MCType+Bunch+"Like"+DataType+"_"+Bunch+"_1Deff_RAW.root";
FileNameOutDataISO = "TnP_TightISO_"+DataType+"_"+Bunch+"_1Deff_RAW.root";
...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Expressions = cms.PSet(
        ...
        ID_Tight_gt20Var = cms.vstring ("ID_Tight_gt20Var", "Tight2012==1 && abs(dB)<0.02 && abs(dzPV)<0.1", "Tight2012", "dB","dzPV"),
        ID_Tight_lt20Var = cms.vstring ("ID_Tight_lt20Var", "Tight2012==1 && abs(dB)<0.01 && abs(dzPV)<0.1", "Tight2012", "dB","dzPV"),
        ID_Tight_Var = cms.vstring ("ID_Tight_Var", "Tight2012==1", "Tight2012"),
    ),
    ...
    Cuts = cms.PSet(
        ...
        ID_Tight_gt20 = cms.vstring("ID_Tight_gt20", "ID_Tight_gt20Var", "0.5"),
        ID_Tight_lt20 = cms.vstring("ID_Tight_lt20", "ID_Tight_lt20Var", "0.5"),
        ID_Tight = cms.vstring("ID_Tight", "ID_Tight_Var", "0.5"),
    ),
    ## What to fit
