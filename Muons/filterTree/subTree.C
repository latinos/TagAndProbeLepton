//for Muon ID study
//void subTree(TString dir="tpTree", TString cut="(tag_IsoMu20_eta2p1 || tag_IsoMu20) && tag_combRelIsoPF04dBeta < 0.15 && tag_pt >= 20 && pt >= 10. && mass > 70 && mass < 130", TString newFile="subTree_IsoMu20_pt10.root") {
// for run>=273423
/void subTree(TString dir="tpTree", TString cut="(tag_IsoMu20_eta2p1 || tag_IsoMu20) && tag_combRelIsoPF04dBeta < 0.15 && tag_pt >= 20 && pt >= 10. && mass > 70 && mass < 130 && run>=273423", TString newFile="subTree_IsoMu20_pt10.root") {
//for MC Id and ISOandTrig are the same, don't change size of file much:
//void subTree(TString dir="tpTree", TString cut="(tag_IsoMu20_eta2p1 || tag_IsoMu20) && tag_combRelIsoPF04dBeta < 0.15 && tag_pt >= 20 && pt >= 10. && mass > 70 && mass < 130", TString newFile="subTree_IsoMu20_pt10.root") {

// for ISO and trigger study
//void subTree(TString dir="tpTree", TString cut="(tag_IsoMu20_eta2p1 || tag_IsoMu20) && tag_combRelIsoPF04dBeta < 0.15 && tag_pt >= 20 && pt >= 10. && mass > 70 && mass < 130 && Medium==1 && abs(dB)<0.02 && abs(dzPV)<0.1", TString newFile="subTree_IsoMu20_pt10.root") {
// for run>=273423
//void subTree(TString dir="tpTree", TString cut="(tag_IsoMu20_eta2p1 || tag_IsoMu20) && tag_combRelIsoPF04dBeta < 0.15 && tag_pt >= 20 && pt >= 10. && mass > 70 && mass < 130 && run>=273423 && Medium==1 && abs(dB)<0.02 && abs(dzPV)<0.1", TString newFile="subTree_IsoMu20_pt10.root") {
