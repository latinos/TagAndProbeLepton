...
//void subTree(TString dir="tpTree", TString cut="run >= 278167 && (Glb || TM) && (tag_IsoMu24 || tag_IsoTkMu24) && tag_combRelIsoPF04dBeta < 0.15 && tag_pt >= 24 && pt >= 10. && mass > 70 && mass < 130", TString newFile="subTree_IsoMu24_ID_pt10.root") {
void subTree(TString dir="tpTree", TString cut="run >= 281613 && DoubleIsoMu17TkMu8dZ_Mu17 > -1", TString newFile="subTree_IsoMu24_ID_pt10.root") {
//MC
...
//
    ...
    TFile *f1 = TFile::Open("subTree_80XRereco_Run2016H_v2_GoldenJSON_Run281613to284035.root");
    //
    // MC      
